//
//  BankCardUploadPhotoViewController.m
//  BusinessPay
//
...
@interface BankCardUploadPhotoViewController(){
    BOOL _isIDCardPhoto;
...
@implementation BankCardUploadPhotoViewController
...
//    self.idCardImageView.image=[UIImage imageNamed:@"icon.png"];
//    self.sceneImageView.image=[UIImage imageNamed:@"icon.png"];
...
-(void)upLoadRequest
{
    BankUploadPhotoDO *bankUploadDO=[[BankUploadPhotoDO alloc] init];
    bankUploadDO.delegate=self;
    bankUploadDO.trancode=kTrancode_RealNameBankCard;
//    bankUploadDO.userName=[self.array objectAtIndex:1];
//    bankUploadDO.bankCardNumber=[self.array objectAtIndex:2];
//    bankUploadDO.bankName=[self.array objectAtIndex:3];
//    bankUploadDO.provinceID=[self.array objectAtIndex:4];
//    bankUploadDO.cityID=[self.array objectAtIndex:5];
//    bankUploadDO.subbranchID=[self.array objectAtIndex:6];
    ...
    bankUploadDO.IDFilePath=[self getImageFromDocumentFilePathWithImageName:IDCardImageName];
    bankUploadDO.photoFilePath=[self getImageFromDocumentFilePathWithImageName:SenceImageName];
    
    bankUploadDO.IDFileName=IDCardImageName;
    bankUploadDO.photoFileName=SenceImageName;
    
    [bankUploadDO upLoadRequest];
...
-(void)upLoadPhotoSuccessWithMessage:(NSString *)message{
    ...
    [User shareUser].bankCardChange=YES;
