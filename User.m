...
//    NSString * MACString = [MyMD5 md5UTF8:xmlStr];
    ...
    // 4.spliceXMLString
    NSString * MACValue =[@"<PACKAGEMAC>" stringByAppendingFormat:@"%@%@",xmlStr,@"</PACKAGEMAC>"];
...
//    NSString * responseXMLStr  = [AESCrypt decrypt:responseString andKey:key];
    ...
    if (responseString.length == kTextLengthZero) {
        responseString = @"<?xml version=\"1.0\" encoding=\"UTF-8\"?><EPOSPROTOCOL><RSPCOD>383838</RSPCOD><RSPMSG>连接服务器失败</RSPMSG></EPOSPROTOCOL>";
    }
